...
public class functiontutorial {
	...
	public static void main(String[] args) {
		...
		System.err.println("names start with A:"+ namesStartWithA);
		...
		DoubleSummaryStatistics averageage2=persons.stream()
				.collect(Collectors.summarizingDouble(Person::getAge));
		System.out.println("statics of age in persons"+ averageage2);
	}
